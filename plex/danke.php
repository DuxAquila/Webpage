...
.kontaktdaten table, .anfrage table, .captcha table { border-spacing:0px; width:290px; border:0px solid;}
...
<div class="kontaktformular">
 ...
 <fieldset class="kontaktdaten">
	...
	<table>
		<tr>
			<td>Vielen Dank. Ihre Nachricht wurde erfolgreich &uuml;bermittelt.</td>		
		</tr>
	</table>
  </fieldset><p>
 <a href="http://www.kontaktformular.com" onclick="window.open(this.href); return false;" title="kontaktformular.com"><!-- Dieser Copyrighthinweis darf NICHT entfernt werden. -->&copy; by kontaktformular.com</a></p>
